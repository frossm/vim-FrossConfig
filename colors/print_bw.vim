...
" highlight LineNr        cterm=italic ctermfg=darkgrey ctermbg=white gui=italic guifg=darkgrey guibg=white 
highlight LineNr        cterm=italic ctermfg=darkgrey ctermbg=lightgrey gui=italic guifg=darkgrey guibg=lightgrey
